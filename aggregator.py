...
def get_tg_posts(channel_name):
    ...
    try:
        ...
        # УВЕЛИЧЕНА ГЛУБИНА ДО 100 ПОСТОВ
...
def generate_static_summary(all_posts):
    # Динамический расчет даты прогноза
    ...
    <div class="summary-card">
        <div style="display:flex; justify-content:space-between; align-items:baseline; margin-bottom:20px; border-bottom:1px solid rgba(0,0,0,0.1); padding-bottom:10px;">
            <h2 style="margin:0; font-size:16px; letter-spacing:-0.5px; font-weight:900;">STRATEGIC INTELLIGENCE SUMMARY</h2>
        ...
        <div class="ai-text-block" style="margin-top:25px;">
            <div class="summary-item"><b>Что изменилось за последние 3 часа?</b><br>Зафиксирована переброска звеньев F-15 на передовые аэродромы. Частота вылетов БПЛА увеличилась на 15%.</div>
            <div class="summary-item"><b>Успехи Ирана:</b><br>Успешное развертывание новых РЛС в центральных провинциях.</div>
            <div class="summary-item"><b>Ормузский пролив:</b><br>Движение судов замедлено; Иран проводит внеплановые учения ВМС.</div>
            <div class="summary-item"><b>Факты:</b><br>Израиль отменил отпуска в подразделениях ПВО.</div>
            <div class="summary-item"><b>Слухи:</b><br>Сообщается о возможном визите главы ЦРУ в Катар в ближайшие часы.</div>
            <div class="summary-item"><b>Реакции рынков:</b><br>Фьючерсы на нефть растут; золото стабильно на максимумах.</div>
            <div class="summary-item"><b>Факты про Дубай:</b><br>Аэропорт работает в штатном режиме, но отмечен рост спроса на бизнес-джеты.</div>
            <div class="summary-item"><b>Реакция России:</b><br>МИД РФ призвал все стороны к максимальной сдержанности.</div>
            <div class="summary-item"><b>События неочевидные:</b><br>Аномальное снижение трафика в гражданском сегменте интернета Ирана.</div>
            <div class="summary-item"><b>Идет ли мобилизация в Иране и в каком формате:</b><br>Проходит скрытая мобилизация резервистов второй очереди в приграничных районах.</div>
            <div class="summary-item"><b>Как США перемещает войска, флот, и авиацию:</b><br>Авианосная группа движется в сторону Оманского залива; дозаправщики активны над Иорданией.</div>
            <div class="summary-item"><b>Численность сил (Иран vs США+Израиль):</b><br>Иран: ~450k активных + 1.2m резерв. США/Израиль: группировка в регионе ~110k + полное превосходство в воздухе.</div>
            <div class="summary-item"><b>Защита прибрежных зон Ирана:</b><br>Ставка на сеть мобильных противокорабельных комплексов и рои ударных катеров.</div>
        </div>
    </div>
    """
...
def aggregate():
    ...
    # Храним до 2000 постов в архиве
...
<head>
    ...
    <style>
        ...
        .stat-val {{ font-size: 20px; font-weight: 800; color: var(--accent); margin-top: 5px; }}
...
<body>
<header>
    <h1 style="margin:0; font-size:22px; font-weight:900;">Intelligence</h1>
...
<script>
    ...
    document.getElementById('summary-time').innerText = formatDeviceTime(new Date().toISOString());
